...
class BaseSelectorBuilder {
     ...
     */
    class(...classes) {
        return this._create(this.base, [...this.attrs, ...classes.map(c => `.${c}`)], this.pseudos);
    }
     ...
     */
    pseudo(...pseudos) {
        return this._create(this.base, this.attrs, [...this.pseudos, ...pseudos.map(p => `:${p}`)]);
    }
     ...
     */
    is(...subSelectors) {
        return this._create(this.base, this.attrs, [...this.pseudos, `:is(${subSelectors.join(', ')})`]);
    }
     ...
     */
    where(...subSelectors) {
        return this._create(this.base, this.attrs, [...this.pseudos, `:where(${subSelectors.join(', ')})`]);
    }
     ...
     */
    has(...subSelectors) {
        return this._create(this.base, this.attrs, [...this.pseudos, `:has(${subSelectors.join(', ')})`]);
    }
...
class SelectorBuilder extends BaseSelectorBuilder {
    ...
    descendant(...descendants) {
        const modifiers = [...this.pseudos, ...this.attrs].join('');
        return this._create(
            this.base.map(selector =>
                descendants.map(d => `${selector}${modifiers} ${d}`)
            ).flat(),
    ...
    child(...children) {
        ...
        return this._create(
            this.base.map(selector =>
                children.map(c => `${selector}${modifiers} > ${c}`)
            ).flat(),
            [], // Reset modifiers for the new instance
            []
        );
    ...
    adjacent(...siblings) {
        ...
        return this._create(
            this.base.map(selector =>
                siblings.map(s => `${selector}${modifiers} + ${s}`)
            ).flat(),
            [], // Reset modifiers for the new instance
            []
        );
...
class HostSelectorBuilder extends BaseSelectorBuilder {
    ...
    descendant(...descendants) {
        ...
        return new SelectorBuilder([hostSelector], [], [])
            .descendant(...descendants);
    }
