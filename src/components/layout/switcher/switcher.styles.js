	...
	return [
		...
		css`
			:host {
				...
				--xb-switcher-border-color: ${ toCSSResult( 'color-gray-300' ) };
				--xb-switcher-border-style: none;
				--xb-switcher-border-width: 1px;
				--xb-switcher-color: unset;
				--xb-switcher-gap: ${ toCSSResult( 'spacing-4' ) };
				--xb-switcher-padding-x: ${ toCSSResult( 'spacing-2' ) };
				--xb-switcher-padding-y: ${ toCSSResult( 'spacing-2' ) };
