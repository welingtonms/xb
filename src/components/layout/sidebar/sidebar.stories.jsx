...
export const Playground = {
	render: ( args ) => (
		<xb-sidebar
			style={ {
				'--xb-sidebar-background-color': 'rgb(var(--xb-color-background))',
				'--xb-sidebar-min-content-width': args.minContentWidth,
			} }
			sidePosition={ args.sidePosition }
