...
import token from '../../utils/to-css-result';
...
// 				--xb-floating-box-shadow: rgba(0, 0, 0, 0.07) 0px 1px 1px, rgba(0, 0, 0, 0.07) 0px 2px 2px,
...
// 				min-block-size: 24px;
// 				inline-size: var(--xb-floating-width);
// 				min-inline-size: var(--xb-floating-min-width);
// 				max-inline-size: var(--xb-floating-max-width);
