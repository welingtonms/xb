...
import SelectionBoundary from '../../common/selection-element';
 ...
 * @typedef {import('../../common/selection-element').SelectionEventDetail} SelectionEventDetail
 * @typedef {import('../../common/selection-element').SelectionOption} SelectionOption
