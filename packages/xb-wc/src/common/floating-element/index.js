 ...
 * @typedef {import('./floating-element').FloatingElementPlacement} FloatingElementPlacement
 * @typedef {import('./floating-element').FloatingElementPosition} FloatingElementPosition
 */
